        ...
        <ul>
          {auctions.map((auction, index) => (
            <div key={index} className="card">
              ...
              <p>
                <strong>Prix actuel de l'enchère:</strong> {auction.actualPrice}{" "}
                MATIC
              </p>
              <p>
                <strong>Prix minimum pour surenchérir: </strong> {auction.price}{" "}
                MATIC
              </p>
              <p>
              ...
              {auctions
                ...
                .map((auction, index) => (
                  <div key={index} className="card">
                    ...
                    <p>
                      <strong>Mise actuel: </strong> {auction.actualPrice} MATIC
                    </p>
                    <p>
                      <strong>Fin :</strong> {auction.endAt}
                    </p>
